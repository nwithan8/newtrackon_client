...
__title__ = "newtrackon"
__author__ = 'Nate Harris'
__author_email__ = 'n8gr8gbln@gmail.com'
__github_username__ = "nwithan8"
__github_repo__ = "newtrackon_client"
__copyright__ = "Copyright © YEARADDEDBYGITHUB - Nate Harris"
__license__ = 'GNU General Public License v3 (GPLv3)'
__description__ = "An API client for newTrackon written in Python."
__keywords__ = ["API", "client", "newTrackon", "torrent", "tracker", "trackers"]
